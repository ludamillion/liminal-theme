...
(defface liminal-sans
  '((t (:family "Noto Sans"
        :weight medium)))
  "Default proportional sans font (Noto Sans, 14pt)."
  :group 'liminal-theme-fonts)

(defface liminal-serif
  '((t (:family "Noto Serif"
        :weight medium)))
  "Default proportional serif font (Noto Serif, 14pt)."
  :group 'liminal-theme-fonts)
...
(defcustom liminal-light-foreground "#2D3A41"
  "Default foreground color"
  :type 'color :group 'liminal-theme-light)

(defcustom liminal-light-background "#F9FAFA"
  "Default background color"
  :type 'color :group 'liminal-theme-light)

(defcustom liminal-light-highlight "#ECEFF1"
  "Highlight color is used to highlight part of the screen."
  :type 'color :group 'liminal-theme-light)

(defcustom liminal-light-subtle "#D2D5D7"
  "Subtle color is used to suggest a physical area on the screen."
  :type 'color :group 'liminal-theme-light)

(defcustom liminal-light-faded "#9EA6AA"
  "Faded face is for information that are less important."
  :type 'color :group 'liminal-theme-light)

(defcustom liminal-light-salient "#2A789E"
  "Salient color is used for information that are important."
  :type 'color :group 'liminal-theme-light)

(defcustom liminal-light-strong "#2D3A41"
  "Strong color is used for information of a structural nature."
  :type 'color :group 'liminal-theme-light)

(defcustom liminal-light-popout "#3E801F"
  "Popout colour is used for information that needs attention."
  :type 'color :group 'liminal-theme-light)

(defcustom liminal-light-critical "#C04949"
  "Critical face is for information that requires immediate action."
  :type 'color :group 'liminal-theme-light)
...
(defun liminal-theme (theme mode)
  ...
  (let ((light '((background light)))
   ...
   '(italic                      ((t (:inherit liminal-faded))))
   ...
   '(show-paren-match              ((t (:inherit liminal-strong))))
