...
(defun liminal-theme (theme phase)
  ...
  (let ((foreground (--d?l liminal-dark-white liminal-light-black))
        (background (--d?l liminal-dark-black liminal-light-white))
        (highlight  (--d?l liminal-dark-grey+ liminal-light-grey+))
        (critical   (--d?l liminal-dark-red   liminal-light-red))
        (salient    (--d?l liminal-dark-cyan  liminal-light-cyan))
        (strong     (--d?l liminal-dark-white liminal-light-black))
        (popout     (--d?l liminal-dark-green liminal-light-green))
        (subtle     (--d?l liminal-dark-grey  liminal-light-grey))
    ...
    (unless liminal-fonts-use
      (custom-theme-set-faces
       theme
       `(default ((t (:foreground ,foreground))))
       `(liminal-strong ((t (:weight bold :foreground ,strong))))))
...
;;                             ;; --- Named Colors ------------------------------------------------
;;                             `(liminal-base16-black ((,light (:foreground "#2D3A41" :background "#3F4F56"
;;                                                                         :weight normal))
;;                                                    (,dark  (:foreground "#2D3A41" :background "#3F4F56"
;;                                                                         :weight normal))))

;;                             `(liminal-base16-white ((,light (:foreground "#f9fafa" :background "#E9EBEC"
;;                                                                         :weight normal))
;;                                                    (,dark  (:foreground "#f9fafa" :background "#E9EBEC"
;;                                                                         :weight normal))))
